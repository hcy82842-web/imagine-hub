  ...
  return (
    <>
      ...
      <form onSubmit={handleSubmit} className="flex gap-3 items-end">
        <textarea
          className="flex-1 dark:bg-gray-800/80 bg-white/80 rounded-xl px-5 py-3.5 text-sm dark:text-gray-100 text-gray-800 border dark:border-gray-700 border-amber-200 focus:border-blue-500/70 outline-none transition-all dark:placeholder:text-gray-600 placeholder:text-gray-400 resize-none min-h-[48px] max-h-48"
          rows={1}
          value={prompt}
